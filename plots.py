...
file_paths = [
    "../hapibd_outputs/hapibd_" + error_rate + "_error/"
        "{}_hapibd_eur." + error_rate + ".ibd.IBD_BM_Result.txt",
    "../refinedibd_outputs/refinedibd_" + error_rate + "_error/{}_modified_"
        "refinedibd_eur." + error_rate + ".ibd.IBD_BM_Result.txt",
    "../fastsmc_outputs/fastsmc_" + error_rate + "_error/"
        "{}_FastSMC_eur." + error_rate + ".ibd.IBD_BM_Result.txt",
    "../RaPID_outputs/rapid_" + error_rate + "_error/"
        "{}_rapid_eur." + error_rate + ".max.IBD_BM_Result.txt",
    "../IBDSeq_outputs/ibdseq_" + error_rate + "_error/"
        "{}_modified_ibdseq_eur." + error_rate + ".ibd.IBD_BM_Result.txt",
    "../query_outputs/query_" + error_rate + "_error/"
        "{}_modified_query." + error_rate + ".ibd.IBD_BM_Result.txt"
]
...
legend_names = [
    "Hap-IBD", "RefinedIBD", "FastSMC", "RaPID", "IBDSeq", "RaPID_Query"
]
